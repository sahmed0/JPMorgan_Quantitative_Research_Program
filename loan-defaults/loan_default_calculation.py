...
class LoanDefaultPredictor:
    def __init__(self, file_path):
        ...
        self.pipeline = None
        # removed credit_lines_outstanding and debt_to_income from features as weights were too high (toy data)
        self.features = ['payment_to_income', 'years_employed', 'fico_score']
    ...
    def check_feature_importance(self):
        """
        Debugging tool to see which feature is driving the decision.
        """
        ...
        model = self.pipeline.named_steps['logistic']
        ...
        print(importance.sort_values(by='Abs_Weight', ascending=False))
